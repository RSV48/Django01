    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=128, verbose_name='наименование продука')),
                ('image', models.ImageField(blank=True, upload_to='product_images')),
                ('short_desc', models.CharField(blank=True, max_length=60, verbose_name='кратокое описание продукта')),
